...
import {customerPage, getEditCustomer, postEditCustomer, orderhistory, ordered, getpostingReview, postpostingReview, reviewList, basket, getPayment, postPayment,getLoginAsCustomer, postLoginAsCustomer} from "../controllers/customerController";
